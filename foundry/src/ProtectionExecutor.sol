...
/// @title LiquidationShieldVault Interface
...
/// @notice Receives callbacks from Reactive Network and executes protection on vault
/// @dev Destination contract deployed on Sepolia - bridges reactive callbacks to vault
